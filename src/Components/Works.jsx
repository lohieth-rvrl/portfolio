...
export default function Works() {
  ...
  return (
    <div className="container text-center py-5 vh-100">
      <button
        onClick={() => navigate(-1)}
        className="btn btn-warning mb-3 d-flex align-items-center gap-2"
      >
      ...
      <div className="row">
        <div className="col-md-12 pb-5">
          <p>"Here are some of the projects I've worked on. Click on the buttons to view the demo or the code."</p>
        </div>
              ...
              <ScrollAnimation animateIn="bounce">
                ...
                <div className="overlay">
                  ...
                  <div className="buttons">
                    <a href={project.demo} target="_blank" rel="noopener noreferrer" className="btn btn-warning d-flex align-items-center gap-2">
                      <FontAwesomeIcon icon={faGlobe} /> Demo
                    </a>
                    <a href={project.github} target="_blank" rel="noopener noreferrer" className="btn btn-dark d-flex align-items-center gap-2">
